...
function TopCircleLogo({ children }: { children: React.ReactElement }) {
    return (
        <div className="rounded-full w-20 h-20 md:w-24 md:h-24 bg-white flex items-center justify-center ring-4 ring-[var(--primary-container)]">
            <div className="size-7 md:size-10 flex items-center justify-center">{children}</div>
        </div>
    )
}