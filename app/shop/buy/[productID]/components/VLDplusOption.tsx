...
export default function VLDplusOption({ enabled, product }: { enabled: boolean, product: Stripe.Product, productOptionVLDplus: Stripe.Product | null }) {

   if (product.metadata.vldplus) {
